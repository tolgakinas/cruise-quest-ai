...
export const Route = createFileRoute("/.lovable/oauth/consent")({
  ...
  errorComponent: ({ error }) => (
    <main className="mx-auto max-w-md px-5 py-24 text-center">
      <h1 className="text-2xl">Authorization request unavailable</h1>
...
function Consent() {
  ...
  return (
    <main className="mx-auto max-w-md px-5 py-24">
      ...
      <h1 className="mt-3 text-center text-3xl">Connect {clientName}</h1>
      <div className="rule-brass mt-8" />
      <p className="mt-8 text-sm text-muted-foreground">
        {clientName} is asking to use Shore Hopper as you. It will be able to search sailings and
        itineraries, browse shore excursions, and read your own bookings.
      </p>
      {error && (
